...
//----------------------------------------------------------------------
   ...
   struct CCS_Matrix
   {
         ...
         CCS_Matrix(int const rows, int const cols, std::vector<pair<int, int> > const& nonZeros)
            : _rows(rows), _cols(cols)
         {
            this->initialize(nonZeros);
         }

		 CCS_Matrix(int const rows, int const cols, std::vector<pair<int, int> > const& nonZeros, std::vector<T> const& values)
            : _rows(rows), _cols(cols)
         {
		 ...
		 void create(int const rows, int const cols, std::vector<pair<int, int> > const& nonZeros)
         {
            _rows = rows;
            _cols = cols;
            this->initialize(nonZeros);
		 ...
		 void create(int const rows, int const cols, std::vector<pair<int, int> > const& nonZeros, std::vector<T> const& values)
         {
            assert(nonZeros.size() == values.size());
		 ...
		 void create(int const rows, int const cols, std::vector<pair<int, int> > const& nonZeros, T const * values)
         {
            _rows = rows;
            _cols = cols;
            this->initialize(nonZeros);
