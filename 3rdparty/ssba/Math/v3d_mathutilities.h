...
namespace V3D
{
   ...
   inline void
	   getEuclideanTransformation(std::vector<Vector3d> const& left_, std::vector<Vector3d> const& right_,
                              Matrix3x3d& R, Vector3d& T)
   {
	  ...
	  std::vector<Vector3d> left(n);
	  std::vector<Vector3d> right(n);
   ...
   inline void
	   getSimilarityTransformation(std::vector<Vector3d> const& left_, std::vector<Vector3d> const& right_,
                               Matrix3x3d& R, Vector3d& T, double& scale)
   {
	  ...
	  std::vector<Vector3d> left(left_);
	  std::vector<Vector3d> right(right_);
