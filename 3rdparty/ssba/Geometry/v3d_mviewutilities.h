...
namespace V3D
{
   ...
   filterConsistentSparsePoints(std::vector<V3D::TriangulatedPoint>& model)
   {
	  ...
	  std::vector<TriangulatedPoint> const origModel(model);
...
/**
  ...
  */
   ...
   Matrix3x3d computeIntersectionCovariance(std::vector<Matrix3x4d> const& projections,
	   std::vector<PointMeasurement> const& measurements,
                                            double sigma);

   double computeIntersectionRoundness(std::vector<Matrix3x4d> const& projections,
	   std::vector<PointMeasurement> const& measurements,
                                       double sigma);
