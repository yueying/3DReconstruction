...
int check_if_png(char *list_file_name, FILE **fp)
{
...
void read_png(char *list_file_name)  /* We need to open the file */
{
   png_structp png_ptr;
   png_infop info_ptr;
...
/* Write a png file */
void write_png(char *list_file_name /* , ... other image information ... */)
{
   FILE *fp;
   png_structp png_ptr;
   png_infop info_ptr;
