#ifndef FBLIB_FEATURE_MATCHER_BRUTE_FORCE_H_
#define FBLIB_FEATURE_MATCHER_BRUTE_FORCE_H_
			...
			*/
				...
				size_t nearest_neighbor_num)
			{
				...
				for (int query_index = 0; query_index < query_num; ++query_index) {
					...
					std::vector<fblib::utils::SortIndexPacketAscend< DistanceType, int> > packet_vec(vec_dist.size());
					fblib::utils::SortIndexHelper(packet_vec, &vec_dist[0], max_min_found);
...
#endif // FBLIB_FEATURE_MATCHER_BRUTE_FORCE_H_
