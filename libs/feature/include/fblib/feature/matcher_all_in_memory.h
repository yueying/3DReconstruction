#ifndef FBLIB_FEATURE_MATCHER_ALL_IN_MEMORY_H_
#define FBLIB_FEATURE_MATCHER_ALL_IN_MEMORY_H_

#include "fblib/feature/features.h"
#include "fblib/feature/indexed_match_decorator.h"
#include "fblib/feature/matching_filters.h"
#include "fblib/feature/matcher.h"
		...
		public:
				...
				const std::string & match_dir) 
			{
				...
				for (size_t j = 0; j < file_names.size(); ++j)  {
					...
					const std::string desc_filename = fblib::utils::create_filespec(match_dir,
						fblib::utils::basename_part(file_names[j]), "desc");
...
#endif // FBLIB_FEATURE_MATCHER_ALL_IN_MEMORY_H_
