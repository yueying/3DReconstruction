#ifndef MVG_FEATURE_ESTIMATOR_ACRANSAC_KERNEL_ADAPTATOR_H_
#define MVG_FEATURE_ESTIMATOR_ACRANSAC_KERNEL_ADAPTATOR_H_
...
#endif // MVG_FEATURE_ESTIMATOR_ACRANSAC_KERNEL_ADAPTATOR_H_
