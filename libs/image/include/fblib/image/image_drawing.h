...
// ::Width()
// ::Height()
#ifndef FBLIB_IMAGE_IMAGE_DRAWING_H_
#define FBLIB_IMAGE_IMAGE_DRAWING_H_
...
namespace fblib {
	namespace image{
		...
		// http://fr.wikipedia.org/wiki/Algorithme_de_trac茅_de_cercle_d'Andres.
		template <typename Image, typename Color>
...
#endif // FBLIB_IMAGE_IMAGE_DRAWING_H_
