#ifndef MVG_MULTIVIEW_ROTATION_AVERAGING_L1_H_
#define MVG_MULTIVIEW_ROTATION_AVERAGING_L1_H_

#include "mvg/multiview/rotation_averaging_common.h"
...
namespace mvg {
	namespace multiview {
		namespace l1  {
			...
			typedef std::vector<mvg::math::Mat3> Matrix3x3Arr;
...
#endif // MVG_MULTIVIEW_ROTATION_AVERAGING_L1_H_
