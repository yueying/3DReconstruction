#ifndef MVG_MULTIVIEW_RESECTION_P3P_H_
#define MVG_MULTIVIEW_RESECTION_P3P_H_

#include <iostream>
#include "mvg/math/numeric.h"
#include "mvg/camera/projection.h"
using namespace mvg::math;
using mvg::camera::EuclideanToHomogeneous;
...
namespace mvg {
	namespace multiview {
		...
		/*
		 *      Author: Laurent Kneip, adapted to mvg by Pierre Moulon
		...
		struct P3PSolver {
			...
			static double Error(const Mat34 & P, const Vec2 & point_2d, const Vec3 & point_3d) {
				return (point_2d - mvg::camera::Project(P, point_3d)).norm();
			}
		};
...
#endif // MVG_MULTIVIEW_RESECTION_P3P_H_
