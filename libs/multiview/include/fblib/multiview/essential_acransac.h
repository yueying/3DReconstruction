#ifndef FBLIB_MULTIVIEW_ESSENTIAL_ACRANSAC_H_
#define FBLIB_MULTIVIEW_ESSENTIAL_ACRANSAC_H_
		...
		struct GeometricFilter_EMatrix_AC
		{
				...
				std::vector<size_t> & vec_inliers) const
			{
				...
				typedef ACKernelAdaptorEssential <
					fblib::multiview::essential::FivePointKernel,
...
#endif // FBLIB_MULTIVIEW_ESSENTIAL_ACRANSAC_H_
