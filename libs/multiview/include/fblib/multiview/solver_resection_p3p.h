#ifndef FBLIB_MULTIVIEW_RESECTION_P3P_H_
#define FBLIB_MULTIVIEW_RESECTION_P3P_H_
...
namespace fblib {
	namespace multiview {
		...
		/*
		 *      Author: Laurent Kneip, adapted to fblib by Pierre Moulon
...
#endif // FBLIB_MULTIVIEW_RESECTION_P3P_H_
