#ifndef MVG_SFM_GLOBAL_SFM_ENGINE_TRIPLET_T_ESTIMATOR_H
#define MVG_SFM_GLOBAL_SFM_ENGINE_TRIPLET_T_ESTIMATOR_H
...
#endif // MVG_SFM_GLOBAL_SFM_ENGINE_TRIPLET_T_ESTIMATOR_H
