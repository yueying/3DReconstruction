#ifndef MVG_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
#define MVG_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
...
#endif // MVG_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
