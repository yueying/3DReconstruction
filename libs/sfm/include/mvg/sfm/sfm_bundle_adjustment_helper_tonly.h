#ifndef MVG_SFM_BUNDLE_ADJUSTMENT_HELPER_TRANSLATION_ONLY_H
#define MVG_SFM_BUNDLE_ADJUSTMENT_HELPER_TRANSLATION_ONLY_H
...
#endif // MVG_SFM_BUNDLE_ADJUSTMENT_HELPER_TRANSLATION_ONLY_H
