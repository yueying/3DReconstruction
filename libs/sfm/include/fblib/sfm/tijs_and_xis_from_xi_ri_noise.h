#ifndef FBLIB_LINFINITY_COMPUTER_VISION_TRANSLATIONANDSTRUCTUREFrom_xi_RI_NOISE_H_
#define FBLIB_LINFINITY_COMPUTER_VISION_TRANSLATIONANDSTRUCTUREFrom_xi_RI_NOISE_H_
...
# undef OFSVAR
		...
		struct TiXi_withNoise_L1_ConstraintBuilder
		{
			...
			bool Build(double gamma, LP_Constraints_Sparse & constraint)
			{
				...
				constraint.parameter_num_ = (Ncam + N3D + NNoiseVar) * 3;
...
#endif // FBLIB_LINFINITY_COMPUTER_VISION_TRANSLATIONANDSTRUCTUREFrom_xi_RI_NOISE_H_
