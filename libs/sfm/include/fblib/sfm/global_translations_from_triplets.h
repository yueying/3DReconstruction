#ifndef FBLIB_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
#define FBLIB_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
...
#undef GAMMAVAR
		...
		struct Tifromtij_ConstraintBuilder_OneLambdaPerTrif
		{
			...
			bool Build(LP_Constraints_Sparse & constraint)
			{
				...
				//  - one gamma parameter.
				constraint.parameter_num_ = _Ncam * 3 + _vec_relative.size() / 3 + 1;
				return true;
			}
...
#endif // FBLIB_SFM_GLOBAL_TRANSLATIONS_FROM_TRIPLETS_H_
