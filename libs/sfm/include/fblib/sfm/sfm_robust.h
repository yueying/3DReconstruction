#ifndef FBLIB_SFM_ROBUST_H
#define FBLIB_SFM_ROBUST_H
  ...
  double * maxError = NULL)
{
  ...
  if (K == NULL)
  {
    typedef fblib::multiview::resection::SixPointResectionSolver SolverType;
  ...
  else
  {
    ...
    //typedef fblib::euclidean_resection::kernel::EpnpSolver SolverType;
    typedef fblib::multiview::P3PSolver SolverType;
    MINIMUM_SAMPLES = SolverType::MINIMUM_SAMPLES;
