#ifndef FBLIB_SFM_LINEAR_PROGRAMMING_INTERFACE_OSI_H_
#define FBLIB_SFM_LINEAR_PROGRAMMING_INTERFACE_OSI_H_
#include <vector>
...
#endif // FBLIB_SFM_LINEAR_PROGRAMMING_INTERFACE_OSI_H_
