 ...
 *
 ********************************************************************************/
#ifndef FBLIB_UTILS_FBLIB_MACROS_H_
#define FBLIB_UTILS_FBLIB_MACROS_H_
...
#define THROW_EXCEPTION_CUSTOM_MSG1(msg,param1)	\
		...
		auxCompStr << "\n\n =============== FBLIB EXCEPTION =============\n";\
		auxCompStr << __CURRENT_FUNCTION_NAME__ << ", line " << __LINE__ << ":\n";\
		auxCompStr << fblib::format(msg,param1)<< std::endl; \
		throw std::logic_error( auxCompStr.str() );\
		}\

//////////////////////////////////将异常封装成宏，减少代码量的书写////////////////////////////////////////
#	define FBLIB_TRY_START	\
	try { \

#define THROW_STACKED_EXCEPTION(e)	\
				{\
		std::string str( e.what() );\
		if (str.find("FBLIB stack trace")==std::string::npos) \
						{ \
...
#if FBLIB_HAS_ASSERT
/**定义一种断言机制.
* \note 不要把必须执行的语句放入，这边只是做一些验证比较.因为在release版本中可能会忽略ASSERT_.* \sa FBLIB_TRY_START, FBLIB_TRY_END
*/
 ...
 */
#if defined(_MSC_VER)
#define FBLIB_ALIGN16 __declspec(align(16))
#define FBLIB_ALIGN32 __declspec(align(32))
#else
#define FBLIB_ALIGN16
#define FBLIB_ALIGN32
#endif
...
#endif // FBLIB_UTILS_FBLIB_MACROS_H_
