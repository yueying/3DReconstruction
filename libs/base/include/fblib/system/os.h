 ...
 *
********************************************************************************/
#ifndef FBLIB_SYSTEM_OS_H_
#define FBLIB_SYSTEM_OS_H_
...
namespace fblib
{
	...
	{	
		...
		/**	格式化输出
		 */
		int BASE_IMPEXP sprintf(char *buf, size_t bufSize, const char *format, ...) FBLIB_NO_THROWS;
