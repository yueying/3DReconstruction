 ...
 *
********************************************************************************/
#ifndef FBLIB_SYNCH_CRITICAL_SECTION_H_
#define FBLIB_SYNCH_CRITICAL_SECTION_H_
...
namespace fblib
{
	...
	namespace synch
	{
		...
		private:
			fblib::utils::ReferencedMemoryBlock m_data; 
			std::string		m_name;
		...
		#define  THREADSAFE_OPERATION(_CRITSECT_OBJ, CODE_TO_EXECUTE )  \
				{ \
					fblib::synch::CriticalSectionLocker lock(&_CRITSECT_OBJ); \
					CODE_TO_EXECUTE \
				}
...
#endif // FBLIB_SYNCH_CRITICAL_SECTION_H_
