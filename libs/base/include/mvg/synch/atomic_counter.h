 ...
 *
********************************************************************************/
#ifndef MVG_SYNCH_ATOMIC_COUNTER_H_
#define MVG_SYNCH_ATOMIC_COUNTER_H_
...
namespace mvg
{
	namespace synch
	{
		...
		*/
		class BASE_IMPEXP AtomicCounter:public mvg::utils::Noncopyable
		{
		public:
...
#endif // MVG_SYNCH_ATOMIC_COUNTER_H_