#ifndef MVG_THREADS_WIN_THREAD_PRIVATE_DATA_H_
#define MVG_THREADS_WIN_THREAD_PRIVATE_DATA_H_

#include <mvg/threads/thread.h>
#include <mvg/threads/block.h>
...
#endif // MVG_THREADS_WIN_THREAD_PRIVATE_DATA_H_
