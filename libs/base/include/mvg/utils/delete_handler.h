#ifndef MVG_UTILS_DELETE_HANDLER_H_
#define MVG_UTILS_DELETE_HANDLER_H_
...
namespace mvg {
	namespace utils{
		...
		public:
			...
			typedef std::pair<unsigned int, const mvg::utils::Referenced*> FrameNumberObjectPair;
			...
			inline void doDelete(const mvg::utils::Referenced* object) { delete object; }
			...
			virtual void requestDelete(const mvg::utils::Referenced* object);
...
#endif // MVG_UTILS_DELETE_HANDLER_H_
