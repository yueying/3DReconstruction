 ...
 *
********************************************************************************/
#ifndef MVG_UTILS_REFERENCED_H_
#define MVG_UTILS_REFERENCED_H_
...
namespace mvg
{
	namespace utils{
		...
		public:
			...
			mvg::threads::Mutex* getRefMutex() const { return getGlobalReferencedMutex(); }

			/** 得到可选的全局 Referenced mutex, 这个可以被使用到所有的mvg::utils::Referenced中*/
			static mvg::threads::Mutex* getGlobalReferencedMutex();
		...
		protected:
			...
			mutable mvg::threads::Atomic     m_refCount;
