...
IF (DISABLE_OPENGL)
	SET(CMAKE_MVG_HAS_OPENGL_GLUT 0)
	SET(CMAKE_MVG_HAS_OPENGL_GLUT_SYSTEM 0)

	SET(CMAKE_MVG_HAS_GLUT 0)
	SET(CMAKE_MVG_HAS_GLUT_SYSTEM 0)
...
ELSE (DISABLE_OPENGL)
	...
	IF(UNIX)
		...
		IF (GLUT_FOUND AND OPENGL_gl_LIBRARY AND OPENGL_glu_LIBRARY AND GLUT_glut_LIBRARY)
			...
			SET(CMAKE_MVG_HAS_OPENGL_GLUT 1)
			SET(CMAKE_MVG_HAS_OPENGL_GLUT_SYSTEM 1)

			SET(CMAKE_MVG_HAS_GLUT 1)
			SET(CMAKE_MVG_HAS_GLUT_SYSTEM 1)
	...
	IF(NOT MSVC)
		# GL, GLU, glut:
		IF(CMAKE_MVG_HAS_OPENGL_GLUT)
			#APPEND_MVG_LIBS(${OPENGL_gl_LIBRARY} ${OPENGL_glu_LIBRARY} ${GLUT_glut_LIBRARY})
			set(MVG_OPENGL_LIBS ${OPENGL_gl_LIBRARY} ${OPENGL_glu_LIBRARY} ${GLUT_glut_LIBRARY})
		ENDIF(CMAKE_MVG_HAS_OPENGL_GLUT)
	ENDIF(NOT MSVC)
