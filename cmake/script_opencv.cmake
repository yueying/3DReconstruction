...
# =========================================================
SET(CMAKE_MVG_HAS_OPENCV 0)
SET(MVG_OPENCV_VERSION 0.0.0)
SET(MVG_OPENCV_VERSION_HEX "0x000")
SET(MVG_OPENCV_SRC_DIR "")
...
IF(NOT CMAKE_MVG_HAS_OPENCV)
	...
	IF(OpenCV_FOUND)
		...
		if (NOT "${BASEDIR}" STREQUAL "")
			SET(MVG_OPENCV_SRC_DIR "${BASEDIR}")
		endif (NOT "${BASEDIR}" STREQUAL "")
		IF($ENV{VERBOSE})
			MESSAGE(STATUS "OpenCV ${OpenCV_VERSION} found through OpenCVConfig.cmake")
		ENDIF($ENV{VERBOSE})

		SET(CMAKE_MVG_HAS_OPENCV 1)
	ENDIF(OpenCV_FOUND)
ENDIF(NOT CMAKE_MVG_HAS_OPENCV)

# 2nd: Invoke pkg-config for getting the configuration:
IF(NOT CMAKE_MVG_HAS_OPENCV AND PKG_CONFIG_FOUND AND NOT OpenCV_IGNORE_PKGCONFIG)
	...
	IF(OPENCV_FOUND)
		...
		ENDIF($ENV{VERBOSE})
	ENDIF(OPENCV_FOUND)
ENDIF(NOT CMAKE_MVG_HAS_OPENCV AND PKG_CONFIG_FOUND AND NOT OpenCV_IGNORE_PKGCONFIG)
...
IF(NOT CMAKE_MVG_HAS_OPENCV)
	...
	IF(OpenCV_FOUND)
		...
		#STRING(REGEX MATCHALL "[0-9]+.[0-9]+.[0-9]+" MVG_OPENCV_VERSION "${STR_CV_VERSION}")
		...
		SET(MVG_OPENCV_VERSION "${CMAKE_OPENCV_VERSION_NUMBER_MAJOR}.${CMAKE_OPENCV_VERSION_NUMBER_MINOR}.${CMAKE_OPENCV_VERSION_NUMBER_PATCH}")

		IF($ENV{VERBOSE})
			MESSAGE(STATUS "OpenCV version detected: ${MVG_OPENCV_VERSION}")
		ENDIF($ENV{VERBOSE})
...
VERSION_TO_HEXADECIMAL(MVG_OPENCV_VERSION_HEX ${MVG_OPENCV_VERSION})
...
SET(CMAKE_MVG_HAS_OPENCV_NONFREE 0)
IF(CMAKE_MVG_HAS_OPENCV)
	...
	#APPEND_MVG_LIBS(${OpenCV_LIBRARIES})
	...
	IF ("${OpenCV_LIBRARIES}" MATCHES ".*opencv_nonfree.*")
		SET(CMAKE_MVG_HAS_OPENCV_NONFREE 1)
	...
	SET(CMAKE_MVG_HAS_OPENCV_SYSTEM 1)

ENDIF(CMAKE_MVG_HAS_OPENCV)
