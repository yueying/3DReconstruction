...
if(CMAKE_FBLIB_HAS_GLUT_SYSTEM)
...
else(CMAKE_FBLIB_HAS_GLUT_SYSTEM)
	SET(HAVE_FREEGLUT_EXT_H 1)
endif(CMAKE_FBLIB_HAS_GLUT_SYSTEM)
...
IF (CMAKE_FBLIB_HAS_SSE3)
	...
	IF (NOT HAVE_PMMINTRIN_H)
		SET(CMAKE_FBLIB_HAS_SSE3 0)
	ENDIF (NOT HAVE_PMMINTRIN_H)
ENDIF(CMAKE_FBLIB_HAS_SSE3)
...
TEST_BIG_ENDIAN(CMAKE_FBLIB_IS_BIG_ENDIAN)
